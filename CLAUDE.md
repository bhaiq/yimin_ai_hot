...
Auto-created tables: `yimin_sources`, `yimin_articles`, `yimin_fetch_runs`, `yimin_daily_reports`, `yimin_daily_report_items`, `yimin_article_daily_analysis`, `yimin_daily_report_events`, `yimin_source_submissions`, `yimin_feedback`, `yimin_market_reports`, `yimin_market_materials`, `yimin_market_project_status`, `yimin_market_feedback`, `yimin_push_tasks`, `yimin_push_logs`, `yimin_push_open_events`, `yimin_wx_token_cache`, `yimin_sso_login_logs`. Database default: `yimin_ai_hot` (MySQL, utf8mb4).
